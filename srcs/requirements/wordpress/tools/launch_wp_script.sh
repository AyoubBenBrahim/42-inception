...
wp post create --post_title="Hi Coders!" --post_content="Hi from 1337 , coding school from Morocco" --post_status=publish --post_author="1337" --path=/var/www/wordpress  --allow-root 
